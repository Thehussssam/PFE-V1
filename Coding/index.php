...
if ($user_id) {
    $checkStmt = $pdo->prepare("SELECT COUNT(*) FROM candidature WHERE id_user = ? AND id_job = ?");
    $checkStmt->execute([$user_id, $job['id_job']]);
...
<div class="job-card">
    ...
    <div class="job-card-footer">
        <?php if ($alreadyApplied): ?>
            <button class="btn-applied" disabled>Applied Before</button>
        <?php else: ?>
